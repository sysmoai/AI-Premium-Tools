-- AIPT D1 migration baseline.
-- This migration is intentionally idempotent and non-destructive so it can
-- establish Wrangler's d1_migrations ledger on the existing production DB.
-- Do not add seed/catalog data here; migrations are schema-only.
